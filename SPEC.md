...
**Statut des tests** : 119 tests `decision-core`, 22 tests `decision-engine`, 7 tests `frontend` (148 au total)
...
119 + 22 + 7 = 148 tests, structurés en classes par cas (`TestX`, une méthode = un scénario).
