...
**Statut des tests** : 116 tests `decision-core`, 22 tests `decision-engine`, 7 tests `frontend` (145 au total)
...
116 + 22 + 7 = 145 tests, structurés en classes par cas (`TestX`, une méthode = un scénario).
